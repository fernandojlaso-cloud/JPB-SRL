      ...
      <div className="bg-slate-900 border border-slate-800 rounded-2xl p-6 shadow-sm flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-xs text-slate-400">
            Control de altas, aprobación de accesos y asignación de obras para comitentes y equipo.
          </p>
        </div>
        ...
        <div className="fixed inset-0 bg-slate-950/80 backdrop-blur-sm flex items-center justify-center p-4 z-50">
          <div className="bg-slate-900 border border-slate-800 rounded-2xl max-w-lg w-full p-6 shadow-2xl space-y-4">
            ...
            <div>
              ...
              >
                {isSuperAdmin && (
                  <option value="director">Director de Proyecto (Control total de obras)</option>
                )}
                <option value="administrativo">Administrativo (Carga de comprobantes e ingresos)</option>
                <option value="comitente">Comitente (Solo Lectura de sus obras)</option>
              </select>
            </div>
