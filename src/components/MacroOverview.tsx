      ...
      <div className="bg-slate-900 border border-slate-800 p-5 rounded-2xl shadow-lg flex flex-col md:flex-row md:items-center md:justify-between gap-4">
        <div>
          ...
          <p className="text-xs text-slate-400 mt-1">
            Visión ejecutiva integral de Grupo SimetriS: balance global de ingresos, gastos totales y estado presupuestario de todos los frentes de obra.
          </p>
        </div>
                ...
                <div>
                  ...
                  <div className="flex items-start justify-between gap-2 mb-2">
                    <div className="flex items-start gap-2.5">
                      {p.name.toUpperCase().includes('JPB') && (
